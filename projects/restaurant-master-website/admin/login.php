...
<body>
    ...
    <div class="login">
        ...
        <h1>Admin Login - Restaurant Project </h1>
        ...
        } elseif (isset($_SESSION['deny-access'])) {
            echo '<br>';
            echo $_SESSION['deny-access']; //Displaying Session Message

            unset($_SESSION['deny-access']); // removing Session Message
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($res == TRUE) {
                ...
                if ($count == 1) {
                    ...
                    //Redirect Page to admin panel home page 
                    header("location:" . SITE_URL . 'admin/home.php');
                } else {
