...
<div class="main-content">
    <div class="wrapper">
        ...
        if (isset($_SESSION['add-category-fail'])) {
            echo $_SESSION['add-category-fail']; //Displaying Session Message
            unset($_SESSION['add-category-fail']); // removing Session Message
...
if (isset($_POST['submit'])) {
    ...
    if ($res == TRUE) {
        ...
        //Create a Session Variable to Display Message
        $_SESSION['add-category-fail'] = "<div class='error'> Failed to add category </div>";
